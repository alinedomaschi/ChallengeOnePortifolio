(() => {
    ...
    const sendEmail = async (e) => {
      ...
      let data = {
        access_key:
          "878d38b1-c164-41f8-817b-984945a194ec",
        email: emailPassed,
      ...
      if (
        ...
        await fetch(
          ...
          .then((res) => {
            ...
            modalText.innerText =
              "Obrigado pelo contato, recebemos sua mensagem com sucesso!";
    ...
    const validateName = (element) => {
      if (element.value.length < 5) {
        ...
        element.previousElementSibling.innerText =
          "Qual o seu nome? -> O nome digitado é muito curto! ";
    ...
    const validateEmail = (element) => {
      if (!emailRegex.test(element.value)) {
        ...
        element.previousElementSibling.innerText =
          "Qual o email? -> O email é inválido! ";
        element.classList.add("invalido");
        return false;
      }
    ...
    const validateSubject = (element) => {
      if (element.value.length < 5) {
        ...
        element.previousElementSibling.innerText =
          "Qual o assunto da mensagem? -> O assunto digitado é muito curto! ";
        element.classList.add("invalido");
        return false;
      }
